...
/**
 * A builder producing {@link ConfigurationProvider}s. If you don't specify the value for one the
 * fields then the default value will be provided - read the constructor's documentation to learn
...
public class ConfigurationProviderBuilder {
   ...
   */
  public ConfigurationProviderBuilder withConfigurationSource(
  ...
  /**
   * Enable metrics emission for {@link ConfigurationProvider}s built by this builder. All metrics
   * will be registered with {@code metricRegistry} and prefixed by {@code prefix}. Provider built
   * by this builder will emit the following metrics:
   * <p>
   ...
   * <li>source.reload</li>
   * </ul>
   * Each of those metrics is of {@link Timer} type (i.e. includes execution time percentiles,
   * execution count, etc.)
   *
  ...
  public ConfigurationProvider build() {
    ...
    Reloadable reloadable = new Reloadable() {
      ...
      public void reload(Properties properties) {
        cachedConfigurationSource.notify(environment, properties);
      }
    };
    ...
    SimpleConfigurationProvider configurationProvider =
        new SimpleConfigurationProvider(cachedConfigurationSource, environment);
    if (metricRegistry != null) {
  ...
  public String toString() {
    return "ConfigurationProviderBuilder{" + "configurationSource=" + configurationSource
        + ", reloadStrategy=" + reloadStrategy + ", environment=" + environment
        + ", metricRegistry=" + metricRegistry + ", prefix='" + prefix + '\'' + '}';
  }
}
