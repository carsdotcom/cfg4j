...
/**
 * Decorator for {@link Reloadable} that emits execution metrics. It emits the following metrics
 * (each of those prefixed with a string passed at construction time):
 * <ul>
