...
public class ConsulConfigurationSourceIntegrationTest {
  ...
  public void setUp() throws Exception {
    ...
    runMockServer();
    source = new ConsulConfigurationSourceBuilder().withHost(server.getHostName())
        .withPort(server.getPort()).build();
  ...
  public void getConfigurationReturnsAllKeysFromGivenEnvironment() throws Exception {
    ...
    assertThat(source.getConfiguration(environment))
        .contains(MapEntry.entry("featureA.toggle", "disabled"));
  }
